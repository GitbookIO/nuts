...
Since version 3.0.0, Nuts can works with [other backends](https://github.com/biw/nuts/tree/master/lib/backends) than GitHub. Feel free to post a Pull-Request to implement such backends!
