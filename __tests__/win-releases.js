...
describe("Windows RELEASES", () => {
  describe("Version Normalization", () => {
    test("should not changed version without pre-release", () => {
    ...
    test("should correctly return to a semver", () => {
  ...
  describe("Parsing", () => {
    ...
    test("should have parsed all lines", () => {
      expect(Array.isArray(releases)).toEqual(true)
      expect(releases.length).toEqual(5)
    })

    test("should parse a one-line file (with utf-8 BOM)", () => {
    ...
    test("should correctly parse sha, version, isDelta, filename and size", () => {
  ...
  describe("Generations", () => {
    ...
    test("should correctly generate a RELEASES file", () => {
      expect(winReleases.generate(releases)).toEqual(input)
    })

    it("should correctly generate filenames", () => {
      expect(
