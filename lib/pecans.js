...
function Pecans(opts) {
    if (!(this instanceof Pecans)) return new Pecans(opts);
    var that = this;
...
Pecans.prototype._init = function() {
    var that = this;
    return Q()
    .then(function() {
...
Pecans.prototype.performQ = function(name, arg, fn) {
    var that = this;
    fn = fn || function() { };
...
Pecans.prototype.serveAsset = function(req, res, version, asset) {
    var that = this;
...
Pecans.prototype.onDownload = function(req, res, next) {
    var that = this;
...
// Request to update
Pecans.prototype.onUpdateRedirect = function(req, res, next) {
    Q()
    .then(function() {
...
Pecans.prototype.onUpdate = function(req, res, next) {
    var that = this;
...
Pecans.prototype.onUpdateWin = function(req, res, next) {
    var that = this;
...
Pecans.prototype.onServeNotes = function(req, res, next) {
    var that = this;
    var tag = req.params.version;
...
Pecans.prototype.onServeVersionsFeed = function(req, res, next) {
    var that = this;
...
Pecans.prototype.onAPIAccessControl = function(req, res, next) {
    this.performQ('api', {
        req: req,
        res: res
    })
