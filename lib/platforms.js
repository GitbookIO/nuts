...
function detectPlatform(platform) {
    ...
    if (name.indexOf('win')  >= 0 || name.indexOf('nupkg') >= 0) prefix = platforms.WINDOWS;
    ...
    if (name.indexOf('32') >= 0
        || name.indexOf('ia32') >= 0
        || name.indexOf('i386') >= 0
        || name.indexOf('nupkg') >= 0) suffix = '32';
    if (name.indexOf('64') >= 0 || name.indexOf('x64') >= 0 || name.indexOf('amd64') >= 0) suffix = '64';
