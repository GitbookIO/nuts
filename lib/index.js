...
var VersionHost = require('./version-host');
...
module.exports = function nuts(opts) {
    opts = _.defaults(opts || {}, {
        ...
        // Secret for GitHub (style) webhook
    ...
    var versionHost = VersionHost(opts);
    var versions = Versions(versionHost, opts);
    ...
    var cacheStore = stores(stores.FileStore, function(req, slot, next) {
        versionHost.streamAsset(req.url).pipe(slot);
    }, {
        root: opts.cache
    });
    ...
    var serveAsset = function(req, res, version, asset) {
        ...
        return Q.nfcall(opts.onDownload, {
            ...
            .then(function() {
                ...
                req._downloadStream = versionHost.streamAsset(asset.download_url);
    ...
    router.get('/update/:platform/:version', function(req, res, next) {
        ...
        Q()
            ...
            .then(function(versions) {
                ...
                var releaseNotes = notes.merge(versions.slice(0, -1), {
                    includeTag: false
                });
    ...
    router.get('/update/:platform/:version/RELEASES', function(req, res, next) {
        ...
        Q()
            ...
            .then(function(versions) {
                ...
                return versionHost.readAsset(asset.download_url)
